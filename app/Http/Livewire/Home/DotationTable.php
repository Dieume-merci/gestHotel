...
final class DotationTable extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Dotation>
     */
    public function datasource(): Builder
    {
        return Dotation::query()->where("entreprise_id",Auth::user()->entreprises->id);
    }
    ...
    */
    ...
    /**
     * PowerGrid Dotation Action Buttons.
     *
    ...
    */
    ...
    /**
     * PowerGrid Dotation Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($dotation) => $dotation->id === 1)
                ->hide(),
        ];
    }
    */
